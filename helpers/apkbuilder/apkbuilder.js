...
module.exports = {
	...
	Build : function(callback){
        ...
        var child = exec('sudo ionic platforms add android && sudo ionic resources && sudo ionic build android', {cwd: '/home/majoca10/shoply/backend/shoply-backend/apps/shoply-app/'});
